    ...
    return (
        <>
            ...
            <div className="requestcontent">
                ...
                <div className="newleaverequest" id="leavereq" onClick={event =>  navigate('/hrrequestleave')}>
                    <img src={plus}></img>
                    <p>Create Leave request</p>
                </div>
                <div className="newleaverequest" id="overreq" onClick={event =>  navigate('/hrrequestovertime')}>
              <img src={plus}></img>
